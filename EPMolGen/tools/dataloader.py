...
from .encode_complex import ComplexData, torchify_dict

#from .ParseFile import Protein, Ligand, parse_sdf_to_dict
from .parse_pdb import Protein, Ligand, parse_sdf_to_dict
#from ParseFile import Protein, Ligand, parse_sdf_to_dict
...
class CrossDocked2020(object):
    ...
    def process(self, raw_file_info):
        try:
            ...
            if self.only_backbone:
                ...
                pocket_dict = Protein(pocket_file).get_atom_dict(removeHs=True)
    ...
    def run(self, dataset_name='crossdocked_pocket10_all_atom_processed.lmdb', lmdb_path=None, 
